                    ...
                    <div>
                        ...
                        <div className="row mb-24">
                            ...
                            <div className="col-7 pt-23">
                                <p className="light text-light">Call are routed in order of skill level. Skill level 5 is the highest level and gets calls frequently while skill level 1 is the lowest level</p>
                            </div>
                        </div>
