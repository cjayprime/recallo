                ...
                <div className="row mb-24">
                    <div className="col-28">
                        <div className="overview blue-hover text-center br-8">
                            ...
                            <div className="pt-32 mb-40">
                                <h4 className="light text-light pb-8 mb-32"> <span>2 users</span><br /><br /><span>100 mins</span></h4>
                                <Button className="br-30" padding={"12px 34px"} background={"var(--text-color)"} text={"#fff"}><h6 className="bold">Subcribe</h6></Button>
                            </div>
                        </div>
                    </div>
                    <div className="col-28">
                        <div className="overview blue-hover text-center br-8">
                            ...
                            <hr />
                            <div className="pt-32 mb-40">
                                <h4 className="light text-light pb-8 mb-32"> <span>5 users</span><br /><br /><span>175 mins</span></h4>
                                <Button className="br-30" padding={"12px 34px"} background={"var(--text-color)"} text={"#fff"}><h6 className="bold">Subcribe</h6></Button>
                            </div>
                        </div>
                    </div>
                    <div className="col-28">
                        <div className="overview blue-hover text-center br-8">
                            ...
                            <hr />
                            <div className="pt-32 mb-40">
                                <h4 className="light text-light pb-8 mb-32"> <span>10 users</span><br /><br /><span>350 mins</span></h4>
                                <Button className="br-30" padding={"12px 34px"} background={"var(--text-color)"} text={"#fff"}><h6 className="bold">Subcribe</h6></Button>
                            </div>
                        </div>
                    </div>
                ...
                <div>
                    <div className="col-64">
                        <div className="overview br-15 p-24 mb-56">
                            <h4 className="bold text-main mb-24">Your current subscription</h4>
                            ...
                            <div className="row">
                                ...
                                <div>
                                    <Button className="br-30 bc-blue" padding={"12px 24px"} background={"#fff"}><h6 className="bold text-blue">Upgrade plan</h6></Button>
                                </div>
                            </div>
                        </div>
                        <div>
