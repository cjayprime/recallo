            ...
            <form>
              ...
              <div className="time-slot">
                ...
                <div className="time-info">
                  ...
                  <p className="light">
                    Extra hours time are Compellingly evolve empowered
                    alignments
                  </p>
                </div>
              </div>
          ...
          <div className="overview br-8 pt-30 pb-32 plr-32">
            <div className="holiday">
              ...
              <div className="holiday-info">
                ...
                <p className="light">
                  Holiday are periods rapidiously implement cutting-edge
                  paradigms without efficient markets
                </p>
              </div>
            </div>
          </div>
