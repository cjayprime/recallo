            ...
            <>
                <div className="support">
                    <div className="support-message">
                        ...
                        <h6 className="light text-light">We are here to help and answer any question you might have.</h6>
                    </div>
                    <div>
                        <form>
                    ...
                    <div className="message-board">
                        <div className="benefits-card">
                            ...
                            <div className="row-direction mb-24">
                                <div><i className="fa fa-phone text-light" aria-hidden="true" />
                                </div>
                                <div className="ml-8">
                            ...
                            <div className="row-direction">
                                <div><i className="fa fa-envelope text-light" aria-hidden="true" />
                                </div>
