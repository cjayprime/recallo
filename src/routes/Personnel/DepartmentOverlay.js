        ...
        return(
            <Overlay open={open} toggle={toggle}>
                <div>
                    ...
                    <div>
                        ...
                        <form className="mb-32">
                            <label>
                                <h6 className="mb-8 light profile-label">Give a short description for the department</h6>
                            </label>
                ...
                <div>
                    ...
                    <h6 className="light text-light mb-32">You can rename, add to description or delete previous departments</h6>
                    <div className="row-direction existing-category-card mb-16">
                        <div className="flex-3 p-16 background-darkgrey">
                            ...
                            <h6 className="light text-light">Department handles matters regarding purchases and rentals</h6>
                        </div>
                    ...
                    <div className="row-direction existing-category-card mb-16">
                        <div className="flex-3 p-16 background-darkgrey">
                            ...
                            <h6 className="light text-light">Department handles matters regarding vehicle parts and knowledge</h6>
                        </div>
                        <div className="flex-1 p-16">
                            <p>No of personnels </p>
                            <p className="mb-8">in department</p>
